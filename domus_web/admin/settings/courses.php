...
if ($hassiteconfig
 ...
 or has_capability('moodle/site:approvecourse', $systemcontext)) { // speedup for non-admins, add all caps used on this page
	...
	$ADMIN->add('courses', new admin_externalpage('galerias', get_string('galerias', 'admin'), $CFG->wwwroot.'/galerias',
				array('moodle/category:manage', 'moodle/course:create')));

	$ADMIN->add('courses', new admin_externalpage('updatemenu', get_string('updatemenu', 'admin'), $CFG->wwwroot.'/course/updatemenu.php',
				array('moodle/category:manage', 'moodle/course:create')));
