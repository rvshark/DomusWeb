    ...
    while($arq = readdir($diraberto)) { // Le o conteudo do arquivo
        ...
        foreach($arr_ext as $ext) {
            ...
            if ($extpos == strlen($arq) and is_file($arq)){ // Verifica se o arquivo é igual ao filtro
                ...
                echo "<a rel='#voverlay' href='engine/swf/player.swf?url=/".$dir.$arq."&volume=100' title='Abrir Video'><img src='data/thumbnails/$arq_nome.png' alt='".$arq_nome[0]."' />".$n."<span></span></a>";
    ...
    while($arq = readdir($diraberto)) { // Le o conteudo do arquivo
        ...
        foreach($arr_ext as $ext) {
            ...
            if ($extpos == strlen($arq) and is_file($arq)){ // Verifica se o arquivo é igual ao filtro
				...
				echo "<a rel='#voverlay' href='http://domus.pucpr.br/slides/".$dir.$arq."' title='Abrir Apresentação'><img src='../videos/engine/images/modelo.png' alt='".$arq_nome[0]."' />".$n."<span></span></a>";
