...
<script type="text/javascript">
	...
	function Acao(name, arquivo)
	{
		...
		{
			window.open("<?php echo $CFG->wwwroot ?>/util/index.php?acao=pdf&arquivo=" + arquivo,"_blank");
			_gaq.push(['_setAccount', 'UA-27676049-1']);
			_gaq.push(['_trackPageview', "<?php echo $CFG->wwwroot ?>/util/index.php?acao=pdf&arquivo=" + arquivo]);			
		}
		else
		{
