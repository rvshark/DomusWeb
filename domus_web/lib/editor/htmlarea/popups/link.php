<?php // $Id: link.php,v 1.6 2007/01/27 23:23:45 skodak Exp $
	...
	$conteudo_id = optional_param('conteudo_id', SITEID, PARAM_INT);
  ...
  <table width="450" border="0" cellspacing="0" cellpadding="2">
  	<tr style="width: 400px">
  		<td><fieldset>
    			...
    			<form method="get" action="<?php echo $CFG-> wwwroot?>/lib/editor/htmlarea/popups/link.php">    				
      ...
      <td width="450" valign="top"><fieldset>
        ...
        "<iframe id=\"fbrowser\" name=\"fbrowser\" src=\"../coursefiles.php?id=".$id."&conteudo_id=".$conteudo_id."&keywords=$keywords\" width=\"420\" height=\"180\"></iframe>":
        ""; ?>
        <p>
        </p>
        <div class="space"></div>
