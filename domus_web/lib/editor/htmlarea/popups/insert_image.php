...
function Init() {
  ...
  if (param) {
      ...
      window.ipreview.location.replace('preview.php?id='+ 21 +'&imageurl='+ param.f_url);
  }
...
function onOK() {
  var required = {
    "f_url": "Inserir o URL",
    "f_alt": "Inserir o texto alternativo"
  };
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
  	<tr>
  		<td><fieldset>
    			...
    			<form method="get" action="<?php echo $CFG-> wwwroot?>/lib/editor/htmlarea/popups/insert_image.php">    				
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="55%" valign="top"><?php
		...
		echo "<br />";
		echo "<iframe id=\"ibrowser\" name=\"ibrowser\" src=\"{$CFG->wwwroot}/lib/editor/htmlarea/coursefiles.php?usecheckboxes=1&id=$id&conteudo_id=$conteudo_id&keywords=$keywords\" style=\"width: 100%; height: 200px;\"></iframe>";
      ?>
      </td>
