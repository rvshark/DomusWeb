...
<?php
    ...
    $lastmodified = filemtime("fckeditor.php");
    $lifetime = 1800;
    ...
    if ($httpsrequired) {
        ...
        $url = preg_replace('|https?://[^/]+|', '', $CFG->wwwroot).'/lib/editor/fckeditor/';
    } else {
        $url = $CFG->wwwroot.'/lib/editor/fckeditor/';
    }
...
var FCKeditor = function( instanceName, width, height, toolbarSet, value )
{
	...
	this.ToolbarSet		= toolbarSet	|| 'Aluno' ;
	this.Value			= value			|| '' ;
	this.BasePath		= '<?php echo $url ?>' ;
 ...
 */
FCKeditor.BasePath = '<?php echo $url ?>' ;
FCKeditor.courseId = '<?php echo optional_param('id', SITEID, PARAM_INT); ?>' ;        
/**
