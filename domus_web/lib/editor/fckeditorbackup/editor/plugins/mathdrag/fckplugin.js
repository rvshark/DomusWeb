...
FCKToolbarItems.RegisterItem( 'MathDrag', new FCKToolbarButton( 'MathDrag', null, null, null, false, true, 77 ) ) ;

FCKCommands.RegisterCommand( 'MathDrag' , new FCKDialogCommand( "Construtor de Fórmulas" , "Construtor de Fórmulas" , FCKConfig.PluginsPath + 'mathdrag/dlg_ins_dragmath.php' , 595, 465 ) ) ;
