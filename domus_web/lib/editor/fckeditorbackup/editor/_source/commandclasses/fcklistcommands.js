...
FCKListCommand.prototype =
{
	...
	_CreateList : function( groupObj, listsCreated )
	{
		...
		var listNode = doc.createElement( this.TagName ) ;
                //Mudei aqui
                if(this.TagName == 'ul'){
                    listNode.setAttribute( 'style', "font-size: inheirt; list-style: circle inside;" ) ;
                }else if (this.TagName == 'ol'){
                    listNode.setAttribute( 'style', "font-size: inheirt; list-style: decimal inside;" ) ;
                }
