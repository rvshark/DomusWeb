...
//  USER is a persistent variable using sessions
	...
	else if($conteudo_id == 0 && $keywords != ""){
		$wdir = "" ;
	}
    ...
    function html_header($course, $wdir, $formfield=""){
        ...
        if (!empty($_SERVER['HTTPS']) and $_SERVER['HTTPS'] != 'off') {
            $url = preg_replace('|https?://[^/]+|', '', $CFG->wwwroot).'/lib/editor/fckeditor/editor/plugins/galeria/';
        } else {
            $url = $CFG->wwwroot.'/lib/editor/fckeditor/editor/plugins/galeria/';
        }
 ...
 * @param $conteudo_id - Filtro id do curso onde sera apenas percorrido a busca. Obs.: id=0 varre todos os diretorios
...
//  $wdir == / or /a or /a/b/c/d  etc
	...
	if($keywords != "")
	{
		...
		$filelist = array_merge($filelist, get_files($fullpath,$allow_extensions));
