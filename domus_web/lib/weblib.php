...
function skip_main_destination() {
		 ...
		 return '<span id="maincontent"><div><ul id="navAbaixo"><li>sss</li></ul></div></span>';
 ...
 * @todo Finish documenting this function
 */
function print_textarea($usehtmleditor, $rows, $cols, $width, $height, $name, $value='', $courseid=0, $return=false, $id='', $conteudoId=0) {
 ...
 */
function use_html_editor($name='', $editorhidebuttons='', $id='',$width ='650',$height ='500') {
    global $THEME;
    global $CFG;
    ...
    echo "$editor = new FCKeditor('$id','$width','$height','Aluno');\n";
