...
class block_wiki_synonymous extends block_base {
     ...
     */
    function init() {
        $this->title = get_string('block_synonymous', 'wiki');
    ...
    function get_content() {
        ...
        if ($wikimanager->page_is_editable($pageid)) {
            $list.='<hr /><form method="post" action="'.$dir.'&amp;gid='.$WS->groupmember->groupid.'&amp;uid='.$WS->member->id.'&amp;page='.urlencode($pagetemp).'"><div>
