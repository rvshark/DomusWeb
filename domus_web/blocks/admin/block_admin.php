...
class block_admin extends block_list {
    ...
    /// Link to the user own profile (except guests)
		...
		//Editar tipo de recursos dos modulos
		$this->content->items[]= '<a title="Editar Tipos de Recurso" href="'.$CFG->wwwroot.'/mod/resource/index.php?id='.$course->id.'&edit=1">Tipos de Recurso</a>';
		$this->content->icons[]='<img src="'.$CFG->pixpath.'/mod/resource/icon_edit.gif" alt="" />';
