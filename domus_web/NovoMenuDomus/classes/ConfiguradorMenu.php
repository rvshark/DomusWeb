...
class ConfiguradorMenu{
	...
	public function __construct(){
		...
		//$this->con->fecharConexao();					// encerra conex�o
		//$this->d($this->log,0);							// mostra log de a��es, mude de 0(zero) para 1(um) para ativar o stop apos impress�o do menu.
	}
	...
	// guarda op��es de menus na pilha
	...
	// busca os conteudos de cada categoria (Filhos de 1� das categorias: Domus, RQT, etc...)
