...
$conteudo_id = optional_param('conteudo_id',PARAM_INT);
...
//Funcao para inserir o arquivo selecionado
function set_value() {
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<?php echo "<iframe id=\"ibrowser\" name=\"ibrowser\" src=\"{$CFG->wwwroot}/files/coursefiles.php?usecheckboxes=1&id=$id&conteudo_id=$conteudo_id&type=$type\" style=\"width: 99%; height: 120px;\"></iframe>";	?>
		</td>
	</tr>
</table>
<br/>
				...
				<table style="width: 100%">
					...
					<tr>
						...
						<td style="text-align: right;width: 10%">							
							<input type="hidden" id="idSearch" name="idSearch" value="<?php //echo $id ?>" />
							<input type="hidden" id="id" name="id" value="<?php echo $id ?>" />
							<input type="hidden" id="conteudo_id" name="conteudo_id" value="<?php echo $conteudo_id ?>" />
							<input type="hidden" id="typeFile" name="typeFile" value="<?php echo $type ?>" />
							<input name="name" type="submit" id="btnBuscar" value="Buscar"/>
						</td>
					</tr>
				</table>
				</form>
		...
		<td width="50%">
			<fieldset style="height: 60px">
				...
				<form id="cfolder" action="../files/coursefiles.php" method="post" target="ibrowser">
						...
						<input type="hidden" name="conteudo_id" value="<?php print($conteudo_id);?>" /> 
