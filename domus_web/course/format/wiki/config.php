 ...
 * @version  $Id: config.php,v 1.5 2007/05/21 10:58:16 pigui Exp $
...
$format['defaultblocks'] =  'participants,wiki_index,recent_activity,'
							.'calendar_upcoming,admin,course_list';
