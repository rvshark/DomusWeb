...
function new_course_module_wiki() {
	...
	add_to_log($course->id, "course", "add mod",
				"../mod/wiki/view.php?id=$newmod->coursemodule",
				"$newmod->modulename $newmod->instance",$newmod->coursemodule);
	add_to_log($course->id, "wiki", "add",
				"view.php?id=$newmod->coursemodule",
				"$newmod->instance", $newmod->coursemodule);
