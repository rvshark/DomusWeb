...
Ext.ux.form.FCKeditor = function(config, fckconfig) { //add fckeditor config object
    this.config = config;
...
Ext.extend(Ext.ux.form.FCKeditor, Ext.form.TextArea, {
    ...
    onRender: function(ct, position) {
        ...
        setTimeoutEx(loadFCKeditor, 100, this.config.id, this.fckconfig); //setTimeoutEx support arguments
    },
...
function loadFCKeditor(element, config) {
    var oFCKeditor = new FCKeditor(element,config['width'],config['height'],config['toolbarSet']);
