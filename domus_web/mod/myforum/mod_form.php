...
class mod_myforum_mod_form extends moodleform_mod {
...
//-------------------------------------------------------------------------------
		...
		$mform->addElement('text', 'name', "Titulo", array('size'=>'64'));
        ...
        $forum_types = myforum_get_forum_types();
        ...
        $options[MYFORUM_INITIALSUBSCRIBE] = get_string('yesinitially', 'forum');
        $options[MYFORUM_DISALLOWSUBSCRIBE] = get_string('disallowsubscribe','forum');
        ...
        $options = array();
        $options[MYFORUM_TRACKING_OPTIONAL] = get_string('trackingoptional', 'forum');
        $options[MYFORUM_TRACKING_OFF] = get_string('trackingoff', 'forum');
        $options[MYFORUM_TRACKING_ON] = get_string('trackingon', 'forum');
...
//-------------------------------------------------------------------------------
        ...
        $mform->addElement('select', 'assessed', get_string('aggregatetype', 'forum') , myforum_get_aggregate_types());
