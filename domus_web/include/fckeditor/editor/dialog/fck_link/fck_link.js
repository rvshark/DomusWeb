...
function SetLinkType( linkType )
{
	...
	ShowE('divLinkTypeUrlConceitos'		, (linkType == 'conceitos') ) ;
	ShowE('divLinkTypeUrlTextos'		, (linkType == 'textos') ) ;
	...
	if( linkType == 'conceitos' )
	  dialog.SetTabVisibility( 'Target'	, (linkType == 'conceitos') ) ;
	
	if( linkType == 'textos' )	
	  dialog.SetTabVisibility( 'Target'	, (linkType == 'textos') ) ;	
}
